      ...
      {open && (
        ...
        >
          <div style={{
            ...
            {/* Input */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '20px 24px', borderBottom: '1px solid #e3eaf1' }}>
                ...
                <div style={{ padding: '12px' }}>
                  {results.map((item, i) => (
                    ...
                    >
                      ...
                      >
                        <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: '#e4f4f2', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', flexShrink: 0 }}>
                          {item.icon}
                        </div>
                        <div style={{ flex: 1 }}>
                          <div style={{ fontSize: '0.9rem', fontWeight: 600, color: '#16265c', marginBottom: '2px' }}>{item.title}</div>
                          <div style={{ fontSize: '0.78rem', color: '#7a8a8f' }}>{item.desc}</div>
                        </div>
                        <div style={{ fontSize: '0.72rem', fontWeight: 600, color: '#0e8d82', background: '#e4f4f2', padding: '3px 10px', borderRadius: '100px' }}>
                          {item.type}
                        </div>
                      </div>
                    </Link>
            ...
            {/* Footer */}
            <div style={{ padding: '12px 24px', borderTop: '1px solid #e3eaf1', display: 'flex', gap: '16px' }}>
