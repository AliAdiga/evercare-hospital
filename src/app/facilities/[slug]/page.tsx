    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5faf9' }}>
        <div style={{ textAlign: 'center' }}>
          <h1 style={{ fontFamily: 'Lora, serif', fontSize: '2rem', color: '#16265c', marginBottom: '12px' }}>Facility not found</h1>
  ...
  return (
    <div style={{ background: '#f5faf9', minHeight: '100vh' }}>
      ...
      <div style={{ paddingTop: '70px', position: 'relative', height: '520px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, rgba(22,38,92,0.88) 0%, rgba(22,38,92,0.35) 100%)' }} />
      ...
      {/* Stats bar */}
      <div style={{ background: '#16265c', padding: '32px 8%' }}>
      ...
      <div style={{ padding: '80px 8%', display: 'grid', gridTemplateColumns: '1fr 360px', gap: '60px' }}>
        ...
        <div>
          ...
          <div style={{ marginBottom: '56px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#15b1a4', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '16px' }}>
              <span style={{ width: '20px', height: '2px', background: '#15b1a4', display: 'inline-block' }} />
              Overview
            </div>
            <h2 style={{ fontFamily: 'Lora, serif', fontSize: '1.8rem', color: '#16265c', marginBottom: '20px' }}>About this facility</h2>
          ...
          <div style={{ marginBottom: '56px' }}>
            ...
            <h2 style={{ fontFamily: 'Lora, serif', fontSize: '1.8rem', color: '#16265c', marginBottom: '24px' }}>See inside</h2>
          ...
          <div style={{ marginBottom: '56px' }}>
            ...
            <h2 style={{ fontFamily: 'Lora, serif', fontSize: '1.8rem', color: '#16265c', marginBottom: '24px' }}>Capabilities & amenities</h2>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
              {facility.features.map((feature) => (
                <div key={feature} style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'white', padding: '16px 20px', borderRadius: '12px', border: '1px solid #e3eaf1' }}>
                  <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#15b1a4', flexShrink: 0 }} />
                  <span style={{ fontSize: '0.88rem', color: '#1c2748', fontWeight: 500 }}>{feature}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Why it matters */}
          <div style={{ background: 'linear-gradient(135deg, #16265c, #1c2748)', borderRadius: '20px', padding: '40px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#2ec9bb', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '16px' }}>
              <span style={{ width: '20px', height: '2px', background: '#2ec9bb', display: 'inline-block' }} />
              Why It Matters
            </div>
        ...
        <div style={{ position: 'sticky', top: '90px', alignSelf: 'start' }}>
          <div style={{ background: 'white', borderRadius: '20px', padding: '32px', border: '1px solid #e3eaf1', marginBottom: '20px' }}>
            ...
            <a href="/#appointment" style={{ display: 'block', background: '#15b1a4', color: 'white', padding: '14px', borderRadius: '100px', textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem', textAlign: 'center', marginBottom: '12px' }}>
              Book Appointment
            </a>
            <a href="tel:+18003827227" style={{ display: 'block', background: '#e4f4f2', color: '#15b1a4', padding: '14px', borderRadius: '100px', textDecoration: 'none', fontWeight: 600, fontSize: '0.9rem', textAlign: 'center' }}>
              Call +1 (800) 382-7227
            </a>
          </div>

          <div style={{ background: 'white', borderRadius: '20px', padding: '32px', border: '1px solid #e3eaf1', marginBottom: '20px' }}>
            <h3 style={{ fontFamily: 'Lora, serif', fontSize: '1.1rem', color: '#16265c', marginBottom: '16px' }}>Location & Hours</h3>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '16px' }}>
              <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: '#e4f4f2', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '16px', flexShrink: 0 }}>📍</div>
              <div>
                <div style={{ fontSize: '0.75rem', color: '#7a8a8f', marginBottom: '2px' }}>Address</div>
                <div style={{ fontSize: '0.88rem', fontWeight: 600, color: '#16265c', lineHeight: 1.5 }}>4200 Evercare Boulevard{'\n'}Downtown Medical District, CA 90210</div>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '16px' }}>
              <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: '#e4f4f2', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '16px', flexShrink: 0 }}>🕐</div>
              <div>
                ...
                <div style={{ fontSize: '0.88rem', fontWeight: 600, color: '#16265c' }}>Open 24 hours, 7 days</div>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.88rem', fontWeight: 600, color: '#16265c' }}>Free on-site · 400 spaces</div>
              </div>
            </div>
          </div>

          <div style={{ background: 'white', borderRadius: '20px', padding: '32px', border: '1px solid #e3eaf1' }}>
            <h3 style={{ fontFamily: 'Lora, serif', fontSize: '1.1rem', color: '#16265c', marginBottom: '16px' }}>Other Facilities</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {[
                ...
                <Link key={f.slug} href={`/facilities/${f.slug}`} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 14px', borderRadius: '10px', background: '#f5faf9', textDecoration: 'none', transition: 'all 0.2s' }}>
                  <span style={{ fontSize: '16px' }}>{f.icon}</span>
                  <span style={{ fontSize: '0.85rem', fontWeight: 500, color: '#1c2748' }}>{f.name}</span>
                </Link>
              ))}
            </div>
          </div>
